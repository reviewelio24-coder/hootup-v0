...
export const metadata: Metadata = {
  title: '이벤트 할인 · 요리・베이킹 · 훗업 HOOT UP',
  description: '요리・베이킹 이벤트 할인 클래스를 만나보세요.',
}

export default function CategoryCookingBakingEventRoute() {
  return (
    <>
      <SiteHeader />
      <main>
        <Suspense fallback={<div className="hoot-container category-page__empty">클래스를 불러오는 중…</div>}>
          <CategoryCookingBakingListing lockedDeal="event" />
        </Suspense>
      </main>
      <SiteFooter />
    </>
