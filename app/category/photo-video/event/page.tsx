...
export const metadata: Metadata = {
  title: '이벤트 할인 · 사진・영상 · 훗업 HOOT UP',
  description: '사진・영상 이벤트 할인 클래스를 만나보세요.',
}

export default function CategoryPhotoVideoEventRoute() {
  return (
    <>
      <SiteHeader />
      <main>
        <Suspense fallback={<div className="hoot-container category-page__empty">클래스를 불러오는 중…</div>}>
          <CategoryPhotoVideoListing lockedDeal="event" />
        </Suspense>
      </main>
      <SiteFooter />
    </>
