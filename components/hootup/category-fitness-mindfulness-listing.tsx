...
function parsePage(value: string | null) {
  ...
  if (n > FITNESS_MINDFULNESS_TOTAL_PAGES) return FITNESS_MINDFULNESS_TOTAL_PAGES
  return Math.floor(n)
}
...
export function CategoryFitnessMindfulnessListing({ lockedSub }: CategoryFitnessMindfulnessListingProps) {
  ...
  const handleSubClick = (item: FitnessMindfulnessSubcategory) => {
  ...
  return (
    <div className="category-page">
      <div className="hoot-container">
        <section className="category-page__banner" aria-label="운동・마음챙김">
          <img
            className="category-page__banner-img"
            src="/figma/img/category-fitness-mindfulness-banner.png"
            alt=""
            aria-hidden="true"
          />
          <h1 className="category-page__banner-title">운동・마음챙김</h1>
        </section>
        ...
        {showPager ? (
          <nav className="category-page__pager" aria-label="페이지 탐색">
            ...
            <button
              ...
              className="category-page__pager-arrow"
              aria-label="다음 페이지"
              disabled={page >= FITNESS_MINDFULNESS_TOTAL_PAGES}
              onClick={() => goToPage(page + 1)}
            >
